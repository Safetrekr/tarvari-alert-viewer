# Project Discovery Prompt — Mobile View (TarvaRI Alert Viewer)

> Copy everything between the ``` fences into Claude Code to begin discovery.
> Placeholders have been pre-filled for this project.
>
...
>
> **Status:** Discovery is COMPLETE. Six specialist documents + OVERVIEW exist in the output directory. This prompt is preserved as a record of the discovery context and can be re-run if a fresh discovery is needed.
>
> Prerequisites:
>
...
Output Directory:     /Users/jessetms/Sites/Safetrekr/tarvari-alert-viewer/docs/plans/mobile-view
Input Signal(s):      docs/plans/mobile-view/OVERVIEW.md (master reference), docs/plans/mobile-view/ux-strategy.md, docs/plans/mobile-view/ui-design-system.md, docs/plans/mobile-view/interface-architecture.md, docs/plans/mobile-view/information-architecture.md, docs/plans/mobile-view/every-time-synthesis.md, docs/plans/mobile-view/protective-ops-review.md
...
MANDATORY PRODUCT OWNER CONSULTATION (STANDARD and DEEP):
  Spawn Task (subagent_type: software-product-owner):
    "I'm conducting project discovery for Mobile View — TarvaRI Alert Viewer.
...
AGENT SELECTION RULES:
  ...
  4. Use mcp__tarvacode-agent-selector__select_best_agent or skills-reslover mcp (if available)
...
Produce exactly TWO files in /Users/jessetms/Sites/Safetrekr/tarvari-alert-viewer/docs/plans/mobile-view:

╔══════════════════════════════════════════════════════════════════════════════╗
║  DELIVERABLE 1: combined-recommendations.md                                ║
╚══════════════════════════════════════════════════════════════════════════════╝

File: /Users/jessetms/Sites/Safetrekr/tarvari-alert-viewer/docs/plans/mobile-view/combined-recommendations.md
...
File: /Users/jessetms/Sites/Safetrekr/tarvari-alert-viewer/docs/plans/mobile-view/agent-roster.md
...
Create a file: /Users/jessetms/Sites/Safetrekr/tarvari-alert-viewer/docs/plans/mobile-view/DISCOVERY-LOG.md at the start of
...
AT SESSION START:
  1. Read /Users/jessetms/Sites/Safetrekr/tarvari-alert-viewer/docs/plans/mobile-view/DISCOVERY-LOG.md
  2. Search memory MCP for prior findings:
     mcp__memory__search_nodes with query: "Mobile View — TarvaRI Alert Viewer discovery"
...
You have WRITE permission on:
  - /Users/jessetms/Sites/Safetrekr/tarvari-alert-viewer/docs/plans/mobile-view (for the two deliverables + DISCOVERY-LOG.md)
...
1. Read the Input Signal(s) at docs/plans/mobile-view/OVERVIEW.md (master reference), docs/plans/mobile-view/ux-strategy.md, docs/plans/mobile-view/ui-design-system.md, docs/plans/mobile-view/interface-architecture.md, docs/plans/mobile-view/information-architecture.md, docs/plans/mobile-view/every-time-synthesis.md, docs/plans/mobile-view/protective-ops-review.md
