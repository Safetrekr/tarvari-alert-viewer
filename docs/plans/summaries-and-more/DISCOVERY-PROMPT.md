# Project Discovery Prompt — Summaries & More (Viewer Side)
...
> Prerequisites:
>
> - TarvaRI Alert Viewer codebase
> - The summaries-and-more.md analysis (protective agent recommendations)
> - Backend Touch-Ups 3 combined-recommendations.md (API dependency reference)
...
Output Directory:     /Users/jessetms/Sites/Safetrekr/tarvari-alert-viewer/docs/plans/summaries-and-more
Input Signal(s):      /Users/jessetms/Sites/Safetrekr/tarvari-alert-viewer/docs/plans/summaries-and-more/summaries-and-more.md
                      /Users/jessetms/Sites/Safetrekr/TarvaRI/plans/touch-ups-3/combined-recommendations.md
...
MANDATORY PRODUCT OWNER CONSULTATION (STANDARD and DEEP):
  Spawn Task (subagent_type: software-product-owner):
    "I'm conducting project discovery for TarvaRI Alert Viewer — Summaries & More.
...
PRE-SELECTED AGENT ROSTER (from prior analysis):

  The following agents were identified via skill-resolver for this project.
  Use these as the starting roster. Add or remove only if discovery reveals
  work that falls outside their combined skill coverage.

  CORE TEAM (assign to work areas):
  | Agent Slug                                    | Activation   | Role                                           | Key Skills Matched                                                    |
  |-----------------------------------------------|--------------|------------------------------------------------|-----------------------------------------------------------------------|
  | world-class-ux-designer                       | #wuxd        | Interaction flows, triage workflows, nav design | C2 (Interaction Design Patterns & Micro-Interactions)                  |
  | world-class-ui-designer                       | #wuid        | Visual specs: badges, strips, toasts, panels    | F40 (Attention Design), F38 (Motion Design), E29 (Design Tokens)      |
  | world-class-autonomous-interface-architect     | #waia        | Notification architecture, interrupt vs ambient | D26 (Real-time Monitoring UX), E36 (Notification Strategy)            |
  | information-architect                          | #ia          | Info hierarchy, geo taxonomy, search IA         | INA-003 (Dashboard IA), INA-012 (Info Hierarchy), INA-019 (Search)    |
  | react-developer                               | #rd          | Implementation: hooks, components, build        | RDV-004 (Hooks Mastery), RDV-019 (Data-Heavy UI), RDV-009 (Build)    |
  | world-class-secret-service-protective-agent    | #wcsspapv11  | Domain reviewer: validates protective ops UX    | B13 (Escalation Thresholds), B11 (Risk Assessment), B15 (GeoMon)     |

  SUPPORTING (lighter involvement):
  | Agent Slug                                    | Activation   | When Needed                                    | Key Skills Matched                                                    |
  |-----------------------------------------------|--------------|------------------------------------------------|-----------------------------------------------------------------------|
  | quality-engineering-lead                       | #qel         | After implementation — test & accessibility     | C4 (CI/CD Test Integration), R1 (Risk-Based Test Outcomes)            |
  | devops-platform-engineer                       | #dpe         | Phase E only — GitHub Pages deployment CI       | DPE-007 (Artifact Management), DPE-026 (Secrets Management)           |

  AGENTS CONSIDERED BUT NOT ASSIGNED:
  | Agent Slug                                    | Why Considered                          | Why Skipped                                                         |
  |-----------------------------------------------|----------------------------------------|---------------------------------------------------------------------|
  | product-analytics-lead                         | Metrics for alert response, engagement  | Premature — instrument after features exist                         |
  | software-product-owner                         | Backlog prioritization                  | summaries-and-more.md already defines the priority sequence         |
  | every-time                                     | Structured reasoning validation         | Already used in summaries doc; #wcsspapv11 provides domain review   |
...
Produce exactly TWO files in /Users/jessetms/Sites/Safetrekr/tarvari-alert-viewer/docs/plans/summaries-and-more:

╔══════════════════════════════════════════════════════════════════════════════╗
║  DELIVERABLE 1: combined-recommendations.md                                ║
╚══════════════════════════════════════════════════════════════════════════════╝

File: /Users/jessetms/Sites/Safetrekr/tarvari-alert-viewer/docs/plans/summaries-and-more/combined-recommendations.md
...
File: /Users/jessetms/Sites/Safetrekr/tarvari-alert-viewer/docs/plans/summaries-and-more/agent-roster.md
...
Create a file: /Users/jessetms/Sites/Safetrekr/tarvari-alert-viewer/docs/plans/summaries-and-more/DISCOVERY-LOG.md at the start of
...
AT SESSION START:
  1. Read /Users/jessetms/Sites/Safetrekr/tarvari-alert-viewer/docs/plans/summaries-and-more/DISCOVERY-LOG.md
  2. Search memory MCP for prior findings:
     mcp__memory__search_nodes with query: "TarvaRI Alert Viewer — Summaries & More discovery"
...
You have WRITE permission on:
  - /Users/jessetms/Sites/Safetrekr/tarvari-alert-viewer/docs/plans/summaries-and-more (for the two deliverables + DISCOVERY-LOG.md)
...
1. Read the Input Signal(s) at /Users/jessetms/Sites/Safetrekr/tarvari-alert-viewer/docs/plans/summaries-and-more/summaries-and-more.md
                      /Users/jessetms/Sites/Safetrekr/TarvaRI/plans/touch-ups-3/combined-recommendations.md
