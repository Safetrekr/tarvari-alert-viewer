...
Plan Directory:       /Users/jessetms/Sites/Safetrekr/tarvari-alert-viewer/docs/plans/summaries-and-more
Master Plan:          /Users/jessetms/Sites/Safetrekr/tarvari-alert-viewer/docs/plans/summaries-and-more/MASTER-PLAN.md
Final Synthesis:      /Users/jessetms/Sites/Safetrekr/tarvari-alert-viewer/docs/plans/summaries-and-more/FINAL-SYNTHESIS.md

Build Command:        pnpm build
Test Command:         pnpm typecheck  (note: pnpm test:unit is not operationally verified — use typecheck as primary)
...
Create a file: /Users/jessetms/Sites/Safetrekr/tarvari-alert-viewer/docs/plans/summaries-and-more/EXECUTION-LOG.md
...
STEP 5: VERIFY BUILD AND TESTS
  Run the project's build and test commands:
    ...
    - pnpm test:unit (all passing, if configured)
...
STEP 6: COMMIT
  ...
  Commit message format:
    ...
    Plan ref: /Users/jessetms/Sites/Safetrekr/tarvari-alert-viewer/docs/plans/summaries-and-more/phase-x-<slug>/ws-x.n-<slug>.md
...
Create a project branch before starting: summaries-and-more
...
1. Read /Users/jessetms/Sites/Safetrekr/tarvari-alert-viewer/docs/plans/summaries-and-more/EXECUTION-LOG.md
...
4. Search memory MCP for prior decisions:
   mcp__memory__search_nodes with query: "TarvaRI Alert Viewer Summaries"
...
You have full read/write permission on:
  ...
  - /Users/jessetms/Sites/Safetrekr/tarvari-alert-viewer/docs/plans/summaries-and-more (the plan docs — for reading SOWs and updating tracker)
