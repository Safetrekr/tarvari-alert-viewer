import { useReducedMotion } from './chunk-37DUMHLB.js';
import { cn } from './chunk-SP3FQ3FK.js';
...
var statusDotVariants = cva("shrink-0 rounded-full", {
  variants: {
    category: {
  ...
  ({
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        ...props,
        children: [
          icon ? /* @__PURE__ */ jsx("span", { className: "shrink-0", children: icon }) : shouldShowDot ? /* @__PURE__ */ jsx(
            "span",
            {
          ...
          /* @__PURE__ */ jsx("span", { "data-slot": "status-label", children: resolvedLabel })
        ]
      }
    );
  }
...
//# sourceMappingURL=chunk-6TGR22WT.js.map
//# sourceMappingURL=chunk-6TGR22WT.js.map